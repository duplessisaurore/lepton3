...
If you're interested in helping build `Lepton3` and all associated components, thank you. 

If you haven't already, please join the [Discord](https://discord.gg/wXzj2cqZ3Q) for discussion about anything `Lepton3` related (or just for fun!).
...
- Blanket rejection of all future contributions to Lepton3.
